...
export const PORTFOLIO_PROJECTS: Project[] = [
  ...
  {
    id: 'custom-family-facade',
    title: 'Parametric Adaptive Facade Family Library',
    category: 'Custom Revit Families',
    thumbnail: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80', caption: 'Custom Parametric Window & Panel Component with Dimension Parameters' },
      { url: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=1200&q=80', caption: 'Adaptive Pattern Applied across Curved Facade Surface' }
    ],
    shortDesc: 'Designed dynamic 3D Revit RFA family models with dynamic formulas, nested parameters, and formula-driven geometric flex testing.',
    fullDesc: 'Created a complex catalog of 45+ parametric Revit families including adaptive exterior louvers, double-glazed curtain wall mullions, MEP pump skids, and custom sanitary fixtures. Built with nested shared parameters for automatic scheduling and IFC export compliance.',
    lod: 'LOD 500',
    softwareUsed: ['Autodesk Revit', 'Dynamo BIM', 'AutoCAD'],
    clientRegion: 'Germany',
    completionDate: 'May 2024',
    keyFeatures: [
      'Fully flex-tested parametric formulas (angle, offset, material specs)',
      'Lightweight geometry optimized for smooth project file performance',
      'IFC parameter mapping for openBIM interoperability',
      'Nested sub-components for modular installation modeling'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'mep-hospital-system',
    title: 'Multi-Story Hospital MEP & HVAC BIM Coordination',
    category: 'MEP Systems',
    thumbnail: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=1200&q=80', caption: 'Color-Coded 3D MEP Piping, HVAC Ducting & Electrical Trays' },
      { url: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=1200&q=80', caption: 'Ceiling Plenum Clearance & Duct Splitter Routing Detail' }
    ],
    shortDesc: 'Detailed MEP (Mechanical, Electrical, Plumbing) 3D modeling for a 6-story medical facility with specialized medical gas pipe routing.',
    fullDesc: 'Comprehensive modeling of HVAC ductwork, chilled water piping, fire protection sprinkler lines, cable trays, and plumbing lines. Coordinated service corridors with limited ceiling heights to maximize spatial efficiency and installation sequencing.',
    lod: 'LOD 400',
    softwareUsed: ['Autodesk Revit MEP', 'Navisworks Manage', 'SysQue'],
    clientRegion: 'Canada',
    completionDate: 'August 2024',
    areaSqFt: '45,000 sq.ft',
    keyFeatures: [
      'Modeled medical gas, domestic water, and HVAC split duct systems',
      'Optimized riser shaft space allocation across 6 floors',
      'Generated precise fabrication spools and pipe hanger locations',
      'Full compliance with ASHRAE and SMACNA drafting standards'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'clash-detection-tower',
    title: '500+ Clash Matrix Resolution for High-Rise Tower',
    category: 'Clash Detection',
    thumbnail: 'https://images.unsplash.com/photo-1541888946425-d0fbb186a5b3?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1541888946425-d0fbb186a5b3?auto=format&fit=crop&w=1200&q=80', caption: 'Navisworks Clash Detective Matrix Visualizer' }
    ],
    shortDesc: 'Executed Navisworks clash detection, clearance checks, and coordination meetings to eliminate 520+ hard and soft clashes.',
    fullDesc: 'Ran automated clash matrix between Architectural, Structural, Electrical, and Mechanical discipline models in Navisworks Manage. Categorized clashes into Critical Structural Hard Clashes, Clearance Soft Clashes, and Maintenance Access Clashes. Generated clear HTML/PDF clash report logs with grid coordinates.',
    lod: 'LOD 400',
    softwareUsed: ['Navisworks Manage', 'Autodesk Revit', 'BIM Track'],
    clientRegion: 'Australia (Sydney)',
    completionDate: 'November 2024',
    areaSqFt: '85,000 sq.ft',
    keyFeatures: [
      'Resolved 520+ inter-disciplinary clashes before site construction',
      'Saved estimated $45,000 in on-site rework and delay costs',
      'Created standardized BIM Coordination Clash Log tracking sheets',
      'Conducted live virtual coordination reviews with design teams'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'documentation-2d-sheets',
    title: 'Permit-Ready Construction Documentation Set',
    category: 'Documentation',
    thumbnail: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=1200&q=80', caption: 'Revit Sheet Layout with Callouts, Schedules, and Legend Tags' }
    ],
    shortDesc: 'Produced 60+ fully tagged, dimensioned architectural and structural Revit sheets ready for city permit submittal.',
    fullDesc: 'Extracted automated construction documentation directly from the coordinated 3D BIM central file. Configured custom title blocks, line weights, annotation tags, view filters, callout details, structural schedules, and wall assembly details adhering to local building code guidelines.',
    lod: 'LOD 300',
    softwareUsed: ['Autodesk Revit', 'AutoCAD', 'Adobe Acrobat Pro'],
    clientRegion: 'United States (Texas)',
    completionDate: 'December 2024',
    areaSqFt: '32,000 sq.ft',
    keyFeatures: [
      '60+ permit sheets: Plans, Elevations, Sections, Details, Schedules',
      'Dynamic keynoting and automated room finishing schedules',
      'Consistent CAD standard line weights, hatch patterns, and dimensioning',
      'Instant sheet revision tracking and PDF sheet publishing'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'industrial-warehouse-bim',
    title: 'Industrial Logistics Hub Steel & Concrete Model',
    category: 'Architectural Modeling',
    thumbnail: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1200&q=80', caption: 'Steel Trusses & Pre-Cast Panel Structural Model' }
    ],
    shortDesc: 'Modeled heavy industrial steel framework, foundation pedestals, and dock bay clearance paths in 3D Revit LOD 350.',
    fullDesc: 'Complete 3D structural and architectural model for a 120,000 sq.ft distribution center. Included custom steel truss assemblies, overhead crane clearance envelopes, and site slope integration.',
    lod: 'LOD 350',
    softwareUsed: ['Autodesk Revit', 'AutoCAD', 'Navisworks'],
    clientRegion: 'Germany (Frankfurt)',
    completionDate: 'January 2025',
    areaSqFt: '120,000 sq.ft',
    keyFeatures: [
      'Parametric steel truss geometry flex testing',
      'Foundation anchor bolt and pedestal detailing',
      'Optimized loading dock logistics clearance envelope'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'university-campus-asbuilt',
    title: 'University Science Complex As-Built & Facility Model',
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=1200&q=80', caption: 'Campus Exterior Laser Scan Point Cloud Overlay' }
    ],
    shortDesc: 'Converted multi-building campus scan data into COBie-compliant facility management BIM models.',
    fullDesc: 'Sub-centimeter accuracy point cloud scan conversion for a 3-building university laboratory complex. Integrated asset tags and COBie parameters for post-occupancy facilities management.',
    lod: 'LOD 400',
    softwareUsed: ['Autodesk Revit', 'ReCap Pro', 'Navisworks'],
    clientRegion: 'United States (Boston)',
    completionDate: 'February 2025',
    areaSqFt: '95,000 sq.ft',
    keyFeatures: [
      'COBie asset parameter integration for FM operations',
      'High-precision exterior brick facade & curtain wall extraction',
      'Laboratory fume hood exhaust piping clearance verification'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'modular-mep-plantroom',
    title: 'Central Chilled Water Plantroom LOD 400 MEP Model',
    category: 'MEP Systems',
    thumbnail: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=1200&q=80', caption: 'Color-Coded Chiller, Pump & Header Pipe Layout' }
    ],
    shortDesc: 'Modeled heavy mechanical equipment, header pipes, pumps, and electrical control panels in LOD 400 for offsite fabrication.',
    fullDesc: 'Modeled central cooling plantroom equipment including centrifugal chillers, primary/secondary pumps, expansion tanks, and electrical control panels with exact manufacturer clearance boxes.',
    lod: 'LOD 400',
    softwareUsed: ['Autodesk Revit MEP', 'Navisworks Manage'],
    clientRegion: 'United Arab Emirates (Dubai)',
    completionDate: 'March 2025',
    areaSqFt: '15,000 sq.ft',
    keyFeatures: [
      'Valves and pipe hanger fabrication detailing',
      'Equipment maintenance clearance envelope checks',
      'Spool drawings for pre-fabricated pipe assemblies'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'custom-glazing-mullion-family',
    title: 'Double-Glazed Modular Curtain Wall Family Suite',
    category: 'Custom Revit Families',
    thumbnail: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=1200&q=80', caption: 'Parametric Curtain Wall Mullion & Panel Family Editor' }
    ],
    shortDesc: 'Created formula-driven adaptive curtain wall panel families with nested thermal break parameters.',
    fullDesc: 'Developed a comprehensive suite of Revit curtain wall mullion and panel families for a curtain wall manufacturer, featuring variable panel thickness, thermal break offsets, and automated schedule reporting.',
    lod: 'LOD 500',
    softwareUsed: ['Autodesk Revit', 'Dynamo'],
    clientRegion: 'United Kingdom',
    completionDate: 'April 2025',
    keyFeatures: [
      'Formula-based geometric flex parameters',
      'Nested structural frame connection plates',
      'Automatic glazing area takeoff calculations'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  },
  {
    id: 'infrastructure-bridge-clash',
    title: 'Highway Overpass Utility & Structural Clash Audit',
    category: 'Clash Detection',
    thumbnail: 'https://images.unsplash.com/photo-1545558014-8692077e9b5c?auto=format&fit=crop&w=800&q=80',
    images: [
      { url: 'https://images.unsplash.com/photo-1545558014-8692077e9b5c?auto=format&fit=crop&w=1200&q=80', caption: 'Navisworks Civil Utility vs Bridge Abutment Clash View' }
    ],
    shortDesc: 'Executed full clash matrix audit between civil underground utility pipes and concrete bridge pile caps.',
    fullDesc: 'Imported civil 3D utility pipelines, stormwater drains, and structural bridge pile foundation models into Navisworks Manage to isolate critical spatial conflicts before construction.',
    lod: 'LOD 350',
    softwareUsed: ['Navisworks Manage', 'Autodesk Revit', 'Civil 3D'],
    clientRegion: 'Qatar',
    completionDate: 'May 2025',
    areaSqFt: '210,000 sq.ft',
    keyFeatures: [
      'Utility pipe slope vs foundation clearance validation',
      'Hard clash report generated with grid references',
      '4D construction staging sequence check'
    ],
    externalUrl: 'https://mirjariyadh.com.bd'
  }
];
