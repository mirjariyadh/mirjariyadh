...
export const PORTFOLIO_PROJECTS: Project[] = [
  {
    ...
    lod: 'LOD 350',
    softwareUsed: ['Autodesk Revit', 'Navisworks Manage', 'AutoCAD',],
  ...
  },
  {
    ...
    category: ['Architectural Modeling', 'Documentation'],
    thumbnail: 'assets/images/projects/east-mc-kinny/t0.webp',
    images: [
      { url: 'assets/images/projects/east-mc-kinny/p0.webp', caption: 'Architectural Residential Revit Model' },
  ...
  },
  {
    ...
    fullDesc: 'Processed over 18GB of point cloud scan data (.e57 format) using Autodesk Recap Pro and imported into Revit. Reconstructed irregular historical brick masonry, tilted columns, original timber roof trusses, and exposed pipework with strict tolerance limits (<5mm deviation).',
    lod: 'LOD 300',
    softwareUsed: ['Autodesk Revit', 'Navisworks'],
  ...
  },
  {
    ...
    images: [
      { url: 'assets/images/projects/hlsl/p0.webp', caption: 'Healthcare Facility 3D BIM Model' },
  ...
  },
  {
    ...
    images: [
      { url: 'assets/images/projects/hvac2/p1.webp', caption: 'HVAC 3D BIM Model for Office Building' },
      { url: 'assets/images/projects/hvac2/p2.webp', caption: 'HVAC 3D BIM Model for Office Building' },
      { url: 'assets/images/projects/hvac2/p3.webp', caption: 'HVAC 3D BIM Model for Office Building' }
    ],
  ...
  },
  {
    ...
    images: [
      { url: 'assets/images/projects/incepta/p1.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p2.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p3.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p4.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p5.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p6.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p7.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p8.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p9.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p10.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p11.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p12.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p13.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p15.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p16.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p17.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' },
      { url: 'assets/images/projects/incepta/p18.webp', caption: 'Architectural & MEP 3D BIM Model for Incepta Pharmaceutical' }
    ],
