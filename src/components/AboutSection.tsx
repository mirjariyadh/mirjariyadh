...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenContact, onSelectExperience }) => {
  const [downloadSuccess, setDownloadSuccess] = useState(false);

  const handleDownloadCV = (e: React.MouseEvent) => {
    // Attempt download or show graceful notification
  ...
  return (
    <div className="w-full bg-[#F7F8FA] dark:bg-[#0B1220] text-[#111827] dark:text-slate-100 transition-colors duration-300 font-sans">
      ...
      <section className="relative py-12 sm:py-16 md:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Two-Column Desktop Layout (Left Column Compact, Right Column Main Content) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start relative z-10">
          
          {/* LEFT COLUMN: Profile Image (Compact ~33% = 4 cols out of 12) */}
          <div className="lg:col-span-4 flex flex-col items-center">
            <div className="relative w-full max-w-[320px] mx-auto aspect-[4/5] rounded-md overflow-hidden bg-white dark:bg-[#111827] border border-[#E5E7EB] dark:border-slate-800 shadow-md group">
              <img
                ...
                onError={(e) => {
                  // Fallback stylish SVG portrait placeholder
          ...
          {/* RIGHT COLUMN: Introduction & Core Expertise (~67% = 8 cols out of 12) */}
          <div className="lg:col-span-8 flex flex-col justify-between space-y-8">
            ...
            {/* Core Expertise Grid (4 Compact Cards) */}
      ...
      {/* ==================================================
          16. OPTIONAL TECHNICAL VISUAL (TECHNICAL DIAGRAM)
         ================================================== */}
      ...
      {/* ==================================================
          11 & 12. HOW I WORK SECTION (LIGHT & DARK ADAPTIVE)
         ================================================== */}
      <section className="bg-[#EEF2F5] dark:bg-[#0B1220] text-[#111827] dark:text-white py-16 sm:py-20 border-t border-b border-[#E5E7EB] dark:border-slate-800 relative overflow-hidden transition-colors">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-[0.03] dark:opacity-[0.05] bg-[linear-gradient(to_right,#000_1px,transparent_1px),linear-gradient(to_bottom,#000_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#fff_1px,transparent_1px),linear-gradient(to_bottom,#fff_1px,transparent_1px)] bg-[size:40px_40px]" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* 5-Step Horizontal Workflow (Desktop) & Vertical Timeline (Mobile) */}
      ...
      <section className="py-16 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Primary Tools Row (3 Primary Technical Cards) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
          
          {/* Card 1: Autodesk Revit (PRIMARY EMPHASIZED TOOL) */}
